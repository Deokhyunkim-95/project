...
<body>
	<div id="main">
		...
		<div id="main_body">
			...
			<p id="title_eatdeal">Eat Deal 
			<i style="font-size:30px" class="fa">&#xf087;</i></p>
				...
				<c:forEach var="data" items="${eat_deal_list}">
					<div id="discount_row">
						...
						<div id="discount_discount">
							<a href="eatdeal.do?discount=${data.discount}">${data.discount}</a>
							<span>% 할인</span>
						</div>
						...
						<span> 음식 종류: </span>	<a href="eatdeal.do?foodstyle=${data.foodstyle}">${data.foodstyle}</a>
						</div>
						
						<div id="discount_loc">
						<span> 지역: </span> <a href="eatdeal.do?loc=${data.loc}">${data.loc}</a>
						</div>
						
						<div id="discount_space"></div>
